 ...
 * bean is disabled very early in the workbench startup process.
 * If you need to do an asynchronous check in your activator, use {@link Workbench#addStartupBlocker(Class)} to block startup
